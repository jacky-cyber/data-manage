...
drop table if exists 卡流水, 其他入库单, 其他出库单, 盘盈单, 外购入库单, 零售单, 零售单明细, 零售单客户, 销售出库单, 盘亏单, 收发汇总表, 调拨单;
...
select copyk3('其他出库单','other_out/kunshan-201411');
select copyk3('其他出库单','other_out/kunshan-201412');
...
--盘盈单
delete from 盘盈单;
select copyk3('盘盈单','overage/guomei-201201-201406');
select copyk3('盘盈单','overage/guomei-201407');
select copyk3('盘盈单','overage/guomei-201408');
select copyk3('盘盈单','overage/guomei-201409');
select copyk3('盘盈单','overage/guomei-201410');
select copyk3('盘盈单','overage/guomei-201411');
select copyk3('盘盈单','overage/guomei-201412');
...
select copyk3('盘盈单','overage/kunshan-201201-201406');
select copyk3('盘盈单','overage/kunshan-201407');
select copyk3('盘盈单','overage/kunshan-201408');
select copyk3('盘盈单','overage/kunshan-201409');
select copyk3('盘盈单','overage/kunshan-201410');
select copyk3('盘盈单','overage/kunshan-201411');
select copyk3('盘盈单','overage/kunshan-201412');
...
select copyk3('外购入库单','purchase/kunshan-201201-201406');
select copyk3('外购入库单','purchase/kunshan-201407');
select copyk3('外购入库单','purchase/kunshan-201408');
select copyk3('外购入库单','purchase/kunshan-201409');
select copyk3('外购入库单','purchase/kunshan-201410');
select copyk3('外购入库单','purchase/kunshan-201411');
select copyk3('外购入库单','purchase/kunshan-201412');
...
select copyk3('销售出库单','sale/kunshan-201411');
select copyk3('销售出库单','sale/kunshan-201412');
...
select copyk3('盘亏单','shortage/kunshan-201201-201406');
select copyk3('盘亏单','shortage/kunshan-201407');
select copyk3('盘亏单','shortage/kunshan-201408');
select copyk3('盘亏单','shortage/kunshan-201409');
select copyk3('盘亏单','shortage/kunshan-201410');
select copyk3('盘亏单','shortage/kunshan-201411');
select copyk3('盘亏单','shortage/kunshan-201412');
...
select copyk3('收发汇总表','warehouse/kunshan-201201-201406');
select copyk3('收发汇总表','warehouse/kunshan-201407');
select copyk3('收发汇总表','warehouse/kunshan-201408');
select copyk3('收发汇总表','warehouse/kunshan-201409');
select copyk3('收发汇总表','warehouse/kunshan-201410');
select copyk3('收发汇总表','warehouse/kunshan-201411');
select copyk3('收发汇总表','warehouse/kunshan-201412');
