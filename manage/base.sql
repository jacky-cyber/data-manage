...
select copyk3('商品','base/product-20150921');
...
select copyk3('部门整合','base/department-20150908');
select copyk3('部门整合','base/department-20150921');
select copyk3('商品辅助','base/product-aid-20150226');
select copygbk('省份','other/provin.txt');
select copyk3('posbank','base/posbank-20150812');
select copygbk('花卡','other/flowercard.csv');
...
set
  是否关联客户 = true
where
  代码 in ('021.0653','021.0751','025.0810','025.1324','025.2301','571.1141','571.2224','571.9146','571.9164','573.495','573.527','573.850','999.0012','999.0040','573.1031','571.9600');
