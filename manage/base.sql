...
drop table if exists 日历, 商超名正则, 客户业务类型, 部门编号, 部门整合, 部门, 仓库, 仓库按代码, 仓库按名称, 机构整合, 机构, 卡资料, 卡类, 客户, 商品, 商品辅助, 商品经营目录;
...
select copyk3('商品','base/product-20150615');
